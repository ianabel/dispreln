...
namespace DispReln {
	namespace Config {
		...
		enum struct ScanTypes { kpar, kx, ky, fprim, tprim, beta, fprim_adj, Invalid = 255 };
		...
		struct Scan {
			...
			Scan( Scan const& o ) : parameter( o.parameter ), mode( o.mode ), values( o.values ), fixed( o.fixed ), 
											box( o.box ), sIndex( o.sIndex ), adjIndex( o.adjIndex ),
											normalization( o.normalization ), beta( o.beta ), tolerance( o.tolerance ) {};
		};
